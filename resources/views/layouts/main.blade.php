...
<body>
	...
	<div class="super_container">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="/" style="font-weight: 300;">Sait_Postroen</a></div>
								<nav class="main_nav">
									<ul>
										...
										<li class="hassubs">
											<a href="#">Categories</a>
											<!-- выводим категории в верхнем меню (выпадающий список) -->
											<ul>
		...
		<!-- выводим контент соответствующей страницы -->
		@yield('content')
